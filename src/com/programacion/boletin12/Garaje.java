...
public class Garaje {
    ...
    public Garaje(com.programacion.boletin12.Coches coche){
        Coche=coche;
    }
    
    
    public Garaje(float tiempo,com.programacion.boletin12.Coches coche) {
        this.tiempo = tiempo;
        Coche = coche;
    }
    ...
    public void setCoche(com.programacion.boletin12.Coches Coche) {
        this.Coche = Coche;
    }
    ...
    public com.programacion.boletin12.Coches getCoche() {
        return Coche;
    }
